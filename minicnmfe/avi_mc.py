...
- The per-frame MC work from ``minicnmfe/motion_correction.py``
...
def concat_avis_to_mc_zarr(
    ...
    *,
    ...
    from minicnmfe.cutout import public_spec, resolve_cutout
    ...
    try:
        ...
        # would slow `import minicnmfe` for callers that never touch the
        # fused path.
